<script setup>
  ...
  import MenuOption from './components/MenuItem.vue';
...
<template>
    <div>
            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://avatars.githubusercontent.com/u/128606778?v=4"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">Thalia Silva</div>
        ...
        <div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
            ...
            <ul>
                <RouterLink to="/">
                    <MenuOption class="ml-[1px]" :iconSize="23" name="Home" iconString="home" pageUrl="/" />
                </RouterLink>
                <RouterLink to="/search">
                    <MenuOption class="ml-[1px]" :iconSize="24" name="Search" iconString="search" pageUrl="/search" />
                </RouterLink>
                <RouterLink to="/library">
                    <MenuOption class="ml-[2px]" :iconSize="23" name="Your Library" iconString="library" pageUrl="/library" />
                </RouterLink>
                <div class="py-3.5"></div>
                <MenuOption :iconSize="24" name="Create Playlist" iconString="playlist" pageUrl="/playlist" />
                <MenuOption class="-ml-[1px]" :iconSize="27" name="Liked Songs" iconString="liked" pageUrl="/liked" />
            </ul>
